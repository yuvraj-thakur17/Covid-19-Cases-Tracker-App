...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lin_world_data.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Toast.makeText(MainActivity.this, "World clicked", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            delayToShowProgress.postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    pieChart.addPieSlice(new PieModel("Recovered", Integer.parseInt(str_recovered), Color.parseColor("#1bb51d")));
